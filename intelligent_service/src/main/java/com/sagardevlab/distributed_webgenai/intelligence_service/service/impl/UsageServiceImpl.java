...
import com.sagardevlab.distributed_webgenai.intelligence_service.client.AccountClient;
import com.sagardevlab.distributed_webgenai.intelligence_service.entity.UsageLog;
import com.sagardevlab.distributed_webgenai.intelligence_service.repository.UsageLogRepository;
...
public class UsageServiceImpl implements UsageService {
    ...
    public void checkDailyTokensUsage() {
        ...
        if (plan == null || Boolean.TRUE.equals(plan.unlimitedAi()) || plan.maxTokensPerDay() == null) return;
