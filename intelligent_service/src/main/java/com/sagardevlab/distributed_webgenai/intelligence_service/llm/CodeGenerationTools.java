...
public class CodeGenerationTools {
    ...
    public List<String> readFiles(
        ...
        for(String path: paths) {
            ...
            String content;
            try {
                content = SecurityContextUtils.callAs(authentication,
                        () -> workspaceClient.getFileContent(projectId, cleanPath));
            } catch (Exception e) {
                log.warn("Could not read file {}: {}", cleanPath, e.getMessage());
                content = "ERROR: file could not be read. It may not exist yet.";
            }
